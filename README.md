...
**Phase 3D.1 — bounded README content foundation:** implemented and under verification. README evidence uses a separate refresh lifecycle, a 256 KiB storage ceiling, source ref/path/blob-SHA provenance, stale protection, and no raw public exposure. Phase 3D.2 will add contribution-document evidence.
