...
**Phase 4B.1 — scalar search filters:** complete. Search can compose exact language, SPDX license, fork, and archived filters. **Phase 4B.2 — topic and star-range filters:** implemented and under verification, adding all-topic containment and inclusive star bounds while preserving deterministic scope-bound pagination.
